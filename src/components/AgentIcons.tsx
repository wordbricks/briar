...
// matches Orca’s Claude/Codex branding. Codex/OpenAI, Grok, OpenCode, and
// OpenRouter use the user-provided artwork bundled with Briar. Cursor and
// Antigravity use the provider artwork already bundled with Briar.
...
export function OpenCodeIcon({ size = 14, className, style }: AgentIconProps) {
  return (
    <img
      alt=""
      aria-hidden
      className={providerArtworkClassName("dark", className)}
      height={size}
      src={opencodeIconUrl}
      style={{
        display: "block",
