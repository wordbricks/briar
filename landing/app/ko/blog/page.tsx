      ...
      <header className="site-header blog-header">
        <div className="shell nav-shell">
          ...
          <nav aria-label={c.aria.mainMenu}>
            ...
            <a className="is-current" href="/ko/blog" aria-current="page">
              {c.nav.blog}
            </a>
            <a href="/ko/download">{c.nav.download}</a>
          </nav>
          <div className="header-actions">
            ...
            <MobileMenu
              ...
              navLinks={[
                ...
                { href: "/ko/blog", label: c.nav.blog, isCurrent: true },
                { href: "/ko/download", label: c.nav.download },
                {
                  href: GITHUB_URL,
                  label: "GitHub",
                  external: true,
