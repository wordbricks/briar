...
export const docsCopy = {
  ko: {
    ...
    getStarted: {
      ...
      checklist: [
        ...
        },
        {
          title: "제한 안에서 전송",
          description:
            "요청 본문은 64KiB 이하, text는 공백 제거 후 1~10,000자이며 웹훅 하나당 60초에 최대 60회까지 요청할 수 있습니다.",
        },
      ],
    ...
    webhooks: {
      ...
      schemaDescription:
        "본문은 application/json이어야 하며 아래 두 필드 외의 값은 허용되지 않습니다.",
      schemaHeaders: ["필드", "형식", "필수", "제약"],
      schemaRows: [
        ["text", "string", "필수", "공백 제거 후 1~10,000자"],
        [
          "eventId",
          "string",
          "선택",
      ...
      idempotency: [
        ...
        "중복 요청의 text가 달라도 최초 메시지는 바뀌지 않습니다. 같은 논리적 이벤트에는 같은 내용과 같은 키를 보내세요.",
  ...
  en: {
    ...
    getStarted: {
      ...
      checklist: [
        ...
        },
        {
          ...
          description:
            "The body is at most 64KiB, text is 1–10,000 characters after trimming, and each webhook accepts up to 60 requests per 60 seconds.",
        },
      ],
    ...
    webhooks: {
      ...
      schemaDescription:
        "The body must be application/json. No properties beyond the two below are accepted.",
      schemaHeaders: ["Field", "Type", "Required", "Constraints"],
      schemaRows: [
        ["text", "string", "Yes", "1–10,000 characters after trimming"],
        [
          "eventId",
          "string",
          "No",
      ...
      idempotency: [
        ...
        "If duplicate requests contain different text, the first message stays unchanged. Send the same content and key for every attempt of one logical event.",
      ...
      limits: [
        ...
        ["Message length", "text: 1–10,000 characters"],
