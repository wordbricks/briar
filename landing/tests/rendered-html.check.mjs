...
test("server-renders the localized changelog from published releases", async () => {
  ...
  assert.match(koreanHtml, /v1\.2\.116/);
  ...
  assert.match(koreanHtml, /v1\.2\.113/);
  ...
  assert.match(koreanHtml, /v1\.2\.109/);
  ...
  assert.match(englishHtml, /v1\.2\.116/);
  ...
  assert.match(englishHtml, /v1\.2\.113/);
  ...
  assert.match(englishHtml, /v1\.2\.109/);
