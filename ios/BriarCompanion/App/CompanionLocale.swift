...
enum L10n {
    ...
    private static let english: [String: String] = [
        ...
        "메시지 또는 @Briar 질문": "Message or ask @Briar",
        "답글 취소": "Cancel reply",
        "갤러리": "Gallery",
        "붙여넣기": "Paste",
        "보내기": "Send",
        ...
        "Briar 답변이 아직 대기 중입니다. 잠시 후 다시 확인해 주세요.": "Briar's reply is still pending. Check again shortly.",
        "메시지는 전송됐지만 Briar 답변 상태를 확인하지 못했습니다. 상세를 새로고침해 주세요.": "The message was sent, but Briar's reply status could not be checked. Refresh the detail.",
        ...
        "%d 실행 중": "%d running",
        "Briar · %@": "Briar · %@",
        "Briar가 답변을 만들지 못했습니다.": "Briar could not create a reply.",
    ...
    private static let chinese: [String: String] = [
        ...
        "%d 실행 중": "%d 个运行中",
        "Briar · %@": "Briar · %@",
        "Briar가 답변을 만들지 못했습니다.": "Briar 无法生成回复。",
