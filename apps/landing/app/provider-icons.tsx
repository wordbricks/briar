...
export function CodexIcon({ size = 18, className }: IconProps) {
  return (
    <svg
      {...svgProps(size, className)}
      fill="currentColor"
...
export function OpenCodeIcon({ size = 18, className }: IconProps) {
  return (
    <svg {...svgProps(size, className)} fill="none" viewBox="0 0 32 40">
...
export function OpenRouterIcon({ size = 18, className }: IconProps) {
  return (
    ...
    >
      <path
        d="M3 7h12.5l-2.25-2.25M15.5 7l-2.25 2.25M21 17H8.5l2.25-2.25M8.5 17l2.25 2.25"
        stroke="currentColor"
        strokeLinecap="round"
...
function RasterIcon({
  ...
  return (
    // Static brand marks from /public; next/image is unnecessary at 18px.
...
export function GrokIcon({ size = 18, className }: IconProps) {
  return (
    <RasterIcon
      alt=""
      className={className}
      size={size}
      src="/providers/grok.png"
    />
  );
}
...
export function CursorIcon({ size = 18, className }: IconProps) {
  return (
    <RasterIcon
      ...
      className={className}
      size={size}
      src="/providers/cursor.png"
    />
  );
}

export function AntigravityIcon({ size = 18, className }: IconProps) {
  return (
    <RasterIcon
      alt=""
      className={className}
...
export const supportedProviders = [
  ...
  { id: "agy", label: "Antigravity", Icon: AntigravityIcon },
