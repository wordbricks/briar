...
nonisolated struct BriarAPI_GetDashboardResponse: @unchecked Sendable {
  ...
  var organizationProviders: [BriarTypes_AgentProvider] {
...
nonisolated struct BriarAPI_ProjectSettings: @unchecked Sendable {
  ...
  var checkpointPolicy: BriarTypes_CheckpointPolicy {
...
nonisolated struct BriarAPI_DashboardRun: @unchecked Sendable {
  ...
  var checkpoint: BriarTypes_WorkflowCheckpoint {
  ...
  var issueCheckpoints: [BriarTypes_WorkflowCheckpointSpec] {
