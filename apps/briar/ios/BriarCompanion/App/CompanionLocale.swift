...
enum L10n {
    ...
    private static let english: [String: String] = [
        ...
        "경고": "Warning",
        "자세히 보기": "Show details",
        "자세히 숨기기": "Hide details",
        "Agent 답변을 만들지 못했습니다": "The Agent could not reply",
        "이 Agent를 실행할 수 있는 사용 가능한 Worker가 없습니다.": "No available Worker can run this Agent.",
        "실행이 실패했습니다": "The run failed",
    ...
    private static let chinese: [String: String] = [
        ...
        "자세히 보기": "查看详情",
        "자세히 숨기기": "收起",
        "Agent 답변을 만들지 못했습니다": "智能体未能回复",
        "이 Agent를 실행할 수 있는 사용 가능한 Worker가 없습니다.": "没有可运行此智能体的 Worker。",
        "실행이 실패했습니다": "运行失败",
        "선호 실행": "首选运行设置",
        "등록": "创建",
        "등록 완료": "已创建",
