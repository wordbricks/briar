...
export async function createWorkspaceInvitation(
  ...
  const invitation = await getWorkspaceInvitationById(db, input.id);
  return invitation
...
export async function acceptWorkspaceInvitation(
  ...
  const invitation = await getWorkspaceInvitationByTokenHash(
    db,
    input.tokenHash,
  );
  ...
  const accepted = await getWorkspaceInvitationByTokenHash(
    db,
    input.tokenHash,
  );
