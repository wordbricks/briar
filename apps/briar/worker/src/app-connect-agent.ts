...
export const createAppAgentService = (
  ...
  listProjectAgentSchedules: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
      const project = await requireProject(
        db,
  ...
  createProjectAgentSchedule: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
      const project = await requireProject(
        db,
  ...
  updateProjectAgentSchedule: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
      const project = await requireProject(
        db,
  ...
  deleteProjectAgentSchedule: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
      const project = await requireProject(
        db,
  ...
  listProjectAgentScheduleRuns: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
      const project = await requireProject(
        db,
  ...
  claimProjectAgentScheduleRun: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
  ...
  completeProjectAgentScheduleRun: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
      const project = await requireProject(
        db,
  ...
  renewProjectAgentScheduleRun: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
      const project = await requireProject(
        db,
  ...
  listProjectAgentSessions: (input) =>
    run(async () => {
      const session = await services.requireSession(auth, request);
      const project = await requireProject(
        db,
