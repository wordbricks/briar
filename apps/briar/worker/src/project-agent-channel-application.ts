...
export type ProjectAgentChannelApplicationErrorReason =
  | "channel_not_found"
  | "channel_forbidden"
  | "thread_parent_not_found"
  | "cursor_invalid";

export class ProjectAgentChannelApplicationError extends Error {
  readonly name = "ProjectAgentChannelApplicationError";

  constructor(
    readonly reason: ProjectAgentChannelApplicationErrorReason,
    message: string,
  ) {
    super(message);
  }
...
export type ProjectAgentChannelApplicationServices = {
...
const projectAgentChannelApplicationServices:
  ProjectAgentChannelApplicationServices = {
    getProjectAgentChannel,
    getProjectOrganizationChannel,
    isChannelRootMessage,
    listChannelMessagePage,
...
const applicationError = (
  reason: ProjectAgentChannelApplicationErrorReason,
  message: string,
): never => {
  throw new ProjectAgentChannelApplicationError(reason, message);
};

export async function listProjectAgentChannelMessagesApplication(
  input: {
  ...
  overrides: Partial<ProjectAgentChannelApplicationServices> = {},
) {
  const services = {
    ...projectAgentChannelApplicationServices,
    ...overrides,
