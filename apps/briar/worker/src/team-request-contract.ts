...
export const TeamTransferInput = Schema.Struct({
...
export const TeamAgentInput = strictSchema(Schema.Struct({
...
const TeamAgentSessionEvent = strictSchema(Schema.Struct({
...
const TeamAgentSessionIssue = strictSchema(Schema.Struct({
...
export const TeamAgentSessionInput = strictSchema(Schema.Struct({
  ...
  issues: mutableArray(TeamAgentSessionIssue).check(Schema.isMaxLength(100)),
  ...
  events: mutableArray(TeamAgentSessionEvent).check(Schema.isMaxLength(200)),
 ...
 */
export const StoredTeamAgentSessionPayload = strictSchema(Schema.Struct({
...
export type StoredTeamAgentSessionPayload =
  typeof StoredTeamAgentSessionPayload.Type;

export const storedTeamAgentSessionPayloadMaxBytes = 1_048_576;
export const storedTeamAgentSessionSummaryMaxBytes = 262_144;
...
const StoredTeamAgentSessionPayloadJson = storedJson(
  StoredTeamAgentSessionPayload,
  storedTeamAgentSessionPayloadMaxBytes,
);

export const decodeStoredTeamAgentSessionPayload =
  Schema.decodeUnknownSync(
    StoredTeamAgentSessionPayloadJson,
    strictSchemaOptions,
  );

export const encodeStoredTeamAgentSessionPayload = Schema.encodeSync(
  StoredTeamAgentSessionPayloadJson,
  strictSchemaOptions,
);

const StoredTeamAgentSessionSummaryIssue = strictSchema(Schema.Struct({
  runId: Schema.String.check(Schema.isLengthBetween(1, 128)),
  runNumber: NonNegativeSafeInteger,
  sourceKey: Schema.String.check(Schema.isLengthBetween(1, 500)),
  title: Schema.String.check(Schema.isLengthBetween(1, 500)),
...
export const StoredTeamAgentSessionSummary = strictSchema(Schema.Struct({
  dispatchGroupId: Schema.String.check(Schema.isLengthBetween(1, 128)),
  agentId: Schema.NullOr(UuidString),
  ...
  issues: mutableArray(StoredTeamAgentSessionSummaryIssue).check(
...
export type StoredTeamAgentSessionSummary =
  typeof StoredTeamAgentSessionSummary.Type;

const StoredTeamAgentSessionSummaryJson = storedJson(
  StoredTeamAgentSessionSummary,
  storedTeamAgentSessionSummaryMaxBytes,
);

export const decodeStoredTeamAgentSessionSummary = Schema.decodeUnknownSync(
  StoredTeamAgentSessionSummaryJson,
  strictSchemaOptions,
);

export const encodeStoredTeamAgentSessionSummary = Schema.encodeSync(
  StoredTeamAgentSessionSummaryJson,
  strictSchemaOptions,
);

export const TeamAgentTaskInput = strictSchema(Schema.Struct({
  agentId: UuidString,
  skillId: Schema.optional(Schema.NullOr(UuidString)),
...
export const TeamAgentTaskSuccess = strictSchema(Schema.Struct({
...
export const TeamAgentTaskFailure = strictSchema(Schema.Struct({
...
export const TeamAgentScheduleInput = ScheduleSource.pipe(
  Schema.decodeTo(
    ScheduleTarget,
...
export const decodeTeamTransferInput = decodeRequestSync(
  TeamTransferInput,
);
export const decodeTeamAgentInput = decodeRequestSync(TeamAgentInput);
export const decodeTeamAgentInputOption = Schema.decodeUnknownOption(
  TeamAgentInput,
...
export const decodeTeamAgentTaskInput = decodeRequestSync(
  TeamAgentTaskInput,
);
export const decodeTeamAgentTaskSuccess = decodeRequestSync(
  TeamAgentTaskSuccess,
);
export const decodeTeamAgentTaskFailure = decodeRequestSync(
  TeamAgentTaskFailure,
);
export const decodeTeamAgentScheduleInput = decodeRequestSync(
  TeamAgentScheduleInput,
);
