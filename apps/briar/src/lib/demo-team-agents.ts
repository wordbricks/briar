  ...
  return [
    {
      ...
      designatedWorkerLabel: null,
      description: defaultAgent.description,
      responsibility: defaultAgent.responsibility,
      skill: teamAgentSkill(defaultAgent),
      skills: [
        defaultTeamAgentSkill({
      ...
      calendarColor: defaultTeamAgentCalendarColor,
      createdAt,
      updatedAt: createdAt,
    },
    {
