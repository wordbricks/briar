...
export const projectIcons: readonly ProjectIconOption[] = [
...
export const projectIconNames: ReadonlySet<string> = new Set(
  projectIcons.map((icon) => icon.name),
);

export function isProjectIconName(value: string): boolean {
  return projectIconNames.has(value);
}

/** Preset swatch colors offered in the icon picker. */
export const projectIconColors: readonly string[] = [
  "#71717a",
  "#dc2626",
  "#ea580c",
  "#ca8a04",
