...
export const commands = {
	...
	retryProjectAutoHuntRun: (projectId: string, runId: string, requestId: string, reason: string) => __TAURI_INVOKE<JsonValueShape>("retry_project_auto_hunt_run", { projectId, runId, requestId, reason }),
	...
	configureExecutionWorker: (projectId: string, userToken: string, enabled: boolean) => __TAURI_INVOKE<JsonValueShape>("configure_execution_worker", { projectId, userToken, enabled }),
	refreshExecutionWorkerRuntime: () => __TAURI_INVOKE<boolean>("refresh_execution_worker_runtime"),
	syncExecutionWorkerLabels: () => __TAURI_INVOKE<JsonValueShape>("sync_execution_worker_labels"),
...
export type JsonValueShape = "Null" | boolean | number | null | string | JsonValueShape[] | { [key in string]: JsonValueShape };
...
export type ProjectLlmRequest = {
	...
	outputSchema?: JsonValueShape | null,
};
