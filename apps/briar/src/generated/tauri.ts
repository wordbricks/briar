...
export const commands = {
	...
	configureExecutionWorker: (projectId: string, userToken: string, enabled: boolean) => __TAURI_INVOKE<JsonValue>("configure_execution_worker", { projectId, userToken, enabled }),
