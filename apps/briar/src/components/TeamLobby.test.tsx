...
import { defaultTeamUsageDateRange } from "../lib/team-usage-summary";
import type { TeamUsageSummary } from "../types";
import { TeamLobby, teamTrackedDuration } from "./TeamLobby";

Object.assign(globalThis, { IS_REACT_ACT_ENVIRONMENT: true });

const emptyUsageSummary: TeamUsageSummary = {
  period: "day",
...
describe("TeamLobby", () => {
  ...
  it("loads the latest 14 days by default and applies a custom date range", async () => {
    const { cleanup, container, root } = createReactTestRoot();
    const expectedDefault = defaultTeamUsageDateRange();
