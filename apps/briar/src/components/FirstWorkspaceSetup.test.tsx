...
import { FirstWorkspaceSetup } from "./FirstWorkspaceSetup";
...
describe("FirstWorkspaceSetup", () => {
  it("asks whether to create or join before showing workspace fields", async () => {
    ...
    expect(container.querySelector('input[autocomplete="workspace"]')).toBeNull();
