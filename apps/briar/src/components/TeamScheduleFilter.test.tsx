...
import {
  TeamSchedule,
  type TeamScheduleServices,
} from "./TeamSchedule";

const scheduleApi = {
  createProjectAgentSchedule:
    vi.fn<TeamScheduleServices["createProjectAgentSchedule"]>(),
  deleteProjectAgentSchedule:
    vi.fn<TeamScheduleServices["deleteProjectAgentSchedule"]>(),
  loadProjectAgentSchedules:
    vi.fn<TeamScheduleServices["loadProjectAgentSchedules"]>(),
  loadProjectAgentScheduleRuns:
    vi.fn<TeamScheduleServices["loadProjectAgentScheduleRuns"]>(),
  loadProjectAgents: vi.fn<TeamScheduleServices["loadProjectAgents"]>(),
  updateProjectAgentSchedule:
    vi.fn<TeamScheduleServices["updateProjectAgentSchedule"]>(),
} satisfies TeamScheduleServices;

const projectId = "22222222-2222-4222-8222-222222222222";
const project = { ...demoDashboard.team, id: projectId };
...
describe("TeamSchedule agent filter", () => {
