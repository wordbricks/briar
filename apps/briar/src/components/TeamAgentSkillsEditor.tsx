...
function positioned(skills: TeamAgentSkillInput[]) {
  return skills.map((skill, position) => ({ ...skill, position }));
}

export function teamAgentSkillInputs(
  skills: readonly TeamAgentSkillInput[],
): TeamAgentSkillInput[] {
...
export function teamAgentSkillsValid(
  skills: readonly TeamAgentSkillInput[],
) {
...
export function TeamAgentSkillsEditor({
  defaultEffort,
  defaultModel,
  defaultProvider,
  disabled = false,
  ...
  disabled?: boolean;
  onChange: (skills: TeamAgentSkillInput[]) => void;
  ...
  const updateSkill = (
    index: number,
    update: Partial<TeamAgentSkillInput>,
  ) => {
    onChange(
      positioned(
                  ...
                  <div className="grid grid-cols-1 gap-2.5 min-[761px]:grid-cols-2">
                    <div className="grid min-w-0 gap-2">
                      ...
                      <NativeSelect
                        ...
                        onValueChange={(value) =>
                          updateSkill(index, {
                            executionMode: value as TeamAgentSkillInput["executionMode"],
                          })
                        }
                        options={[
                    ...
                    <div className="grid min-w-0 gap-2">
                      ...
                      <NativeSelect
                        ...
                        onValueChange={(value) =>
                          updateSkill(index, {
                            approvalPolicy: value as TeamAgentSkillInput["approvalPolicy"],
                          })
                        }
                        options={[
