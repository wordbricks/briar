...
export function TeamAgentSettings({
  agent,
  isDeleteDisabled,
  isSidebarOpen,
  onBack,
  ...
  const [skills, setSkills] = useState(() =>
    teamAgentSkillInputs(agent.skills),
  );
  const [savedProfile, setSavedProfile] = useState({
    ...
    skills: teamAgentSkillInputs(agent.skills),
  ...
  const saveProfile = async () => {
    ...
    try {
      const saved = await onSave({
        ...
        skills: teamAgentSkillInputs(skills),
        calendarColor,
      });
      const nextProfile = {
        name: saved.name,
        ...
        skills: teamAgentSkillInputs(saved.skills),
