...
import {
  ...
  type ProjectMergeActivity as MergeActivity,
  type ProjectMergeActivityLoader,
} from "../lib/project-merge-activity";
import { Spinner } from "./ui/spinner";
import "./ProjectMergeActivity.css";
...
export function ProjectMergeActivity({ projectId, repository, onLoad, refreshKey = 0 }: {
  projectId: string;
  repository: string | null | undefined;
  onLoad?: ProjectMergeActivityLoader;
  refreshKey?: number;
}) {
  const { t } = useI18n();
