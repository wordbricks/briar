/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e793a10f6dcd96c1ff5f50608e2f7bb5)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DM_MEMORY_INDEX_ENABLED" | "DM_MEMORY_RETRIEVAL_ENABLED" | "DM_MEMORY_MINIMUM_SCORE" | "AGENT_MESSAGE_HOURLY_LIMIT" | "WHATSAPP_GRAPH_API_VERSION" | "WHATSAPP_APP_ORIGIN" | "APNS_TEAM_ID" | "MANAGED_COMPUTER_AWS_REGION" | "MANAGED_COMPUTER_AWS_LAUNCH_TEMPLATE_ID" | "MANAGED_COMPUTER_AWS_LAUNCH_TEMPLATE_VERSION" | "MANAGED_COMPUTER_REMOTE_DESKTOP_ENABLED" | "RELEASE_PROMOTION_SECRET" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_SIGNING_SECRET" | "SLACK_TOKEN_ENCRYPTION_KEY" | "MANAGED_COMPUTER_PROMOTION_CODE" | "MANAGED_COMPUTER_ENROLLMENT_SECRET" | "MANAGED_COMPUTER_AWS_ACCESS_KEY_ID" | "MANAGED_COMPUTER_AWS_SECRET_ACCESS_KEY">> {}
}
declare module "*.svg" {
	const value: string;
