...
-- briar_agent_providers, so a new provider is one row instead of a rebuild of
...
insert into briar_agent_providers (provider, proto_name)
values ('codex', 'AGENT_PROVIDER_CODEX');

insert into briar_agent_providers (provider, proto_name)
values ('claude', 'AGENT_PROVIDER_CLAUDE');

insert into briar_agent_providers (provider, proto_name)
values ('cursor', 'AGENT_PROVIDER_CURSOR');

insert into briar_agent_providers (provider, proto_name)
values ('grok', 'AGENT_PROVIDER_GROK');

insert into briar_agent_providers (provider, proto_name)
values ('agy', 'AGENT_PROVIDER_AGY');

insert into briar_agent_providers (provider, proto_name)
values ('opencode', 'AGENT_PROVIDER_OPENCODE');

insert into briar_agent_providers (provider, proto_name)
values ('openrouter', 'AGENT_PROVIDER_OPENROUTER');

insert into briar_agent_providers (provider, proto_name)
values ('vertex', 'AGENT_PROVIDER_VERTEX');

insert into briar_agent_providers (provider, proto_name)
values ('pi', 'AGENT_PROVIDER_PI');
...
drop trigger if exists "briar_channel_reply_agent_message_hop_update_guard";

drop trigger if exists "briar_whatsapp_connections_agent_insert";

drop trigger if exists "briar_whatsapp_connections_agent_update";

drop trigger if exists "briar_whatsapp_user_links_scope_insert";

drop trigger if exists "briar_whatsapp_user_links_scope_update";
...
create table "briar_provider_backup_channel_message_relays" as select * from "briar_channel_message_relays";
...
create table "briar_provider_backup_whatsapp_connections" as select * from "briar_whatsapp_connections";

create table "briar_provider_backup_whatsapp_events" as select * from "briar_whatsapp_events";

create table "briar_provider_backup_whatsapp_outbox" as select * from "briar_whatsapp_outbox";

create table "briar_provider_backup_whatsapp_user_links" as select * from "briar_whatsapp_user_links";

drop table "briar_whatsapp_user_links";

drop table "briar_whatsapp_outbox";

drop table "briar_whatsapp_events";

drop table "briar_whatsapp_connections";
...
drop table "briar_channel_message_relays";
...
delete from "briar_whatsapp_connections";
...
delete from "briar_channel_message_relays";
...
insert into "briar_channel_message_relays" select * from "briar_provider_backup_channel_message_relays";
...
insert into "briar_whatsapp_connections" select * from "briar_provider_backup_whatsapp_connections";

insert into "briar_whatsapp_events" select * from "briar_provider_backup_whatsapp_events";

insert into "briar_whatsapp_outbox" select * from "briar_provider_backup_whatsapp_outbox";

insert into "briar_whatsapp_user_links" select * from "briar_provider_backup_whatsapp_user_links";

drop table "briar_provider_backup_whatsapp_user_links";

drop table "briar_provider_backup_whatsapp_outbox";

drop table "briar_provider_backup_whatsapp_events";

drop table "briar_provider_backup_whatsapp_connections";
...
drop table "briar_provider_backup_channel_message_relays";
