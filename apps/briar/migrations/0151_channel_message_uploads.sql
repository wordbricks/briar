...
-- shared upload capability transport. Rebuild the two fresh upload tables to
-- add the user/channel scope and the channel_message purpose; no deployed
-- legacy wire contract is retained.
...
select request_id, purpose, organization_id, project_id, null, null,
       work_id, run_id, worker_id, device_id, claim_token_hash, metadata_hash,
       file_count, creation_nonce, expires_at, created_at
