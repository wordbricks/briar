...
export const workerD1TestFiles = [
  ...
  "worker/src/app-connect-project-mutations.test.ts",
  ...
  "worker/src/dashboard-change-repository.test.ts",
  ...
  "worker/src/project-channel-messages.test.ts",
  "worker/src/project-repository.test.ts",
