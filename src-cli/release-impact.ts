...
const alwaysBuildPatterns = [
  ...
  /^src-cli\/(?:production-release|release-impact|release-manifest)\.(?:ts|test\.ts)$/u,
  /^src-tauri\/(?:Entitlements\.plist|Info\.plist|build\.rs)$/u,
  /^src-tauri\/(?:binaries|capabilities|icons)\//u,
];
