-- Add agy to every persisted Agent provider constraint.
...
create table "briar_provider_backup_execution_workers" as select * from "briar_execution_workers";
...
create table "briar_provider_backup_project_execution_worker_allowlist" as select * from "briar_project_execution_worker_allowlist";

create table "briar_provider_backup_project_execution_worker_policies" as select * from "briar_project_execution_worker_policies";
...
drop table "briar_project_execution_worker_policies";

drop table "briar_project_execution_worker_allowlist";
...
CREATE TABLE briar_agent_skill_execution_approval_audit (
  ...
  provider text not null
    check (provider in ('codex', 'claude', 'grok', 'opencode', 'agy')),
  model text,
  effort text check (
...
CREATE TABLE "briar_execution_workers" (
  ...
  agent_provider text not null
    check (agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')),
...
CREATE TABLE "briar_hunt_runs" (
  ...
  requested_agent_provider text check (
    ...
    or requested_agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')
  ),
  preferred_agent_provider text check (
    preferred_agent_provider is null
    or preferred_agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')
  ),
...
CREATE TABLE "briar_channel_messages" (
  ...
  author_agent_provider text check (
    ...
    or author_agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')
  ),
...
CREATE TABLE briar_channel_agent_reply_jobs (
  ...
  agent_provider text check (
    ...
    or agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')
  ),
...
CREATE TABLE "briar_issue_agent_reply_jobs" (
  ...
  preferred_provider text
    check (preferred_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')),
  agent_provider text
    check (agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')),
  claim_token_hash text,
  claimed_at text,
  ...
  updated_at text not null,
  completed_at text, skill_id text
    references briar_agent_skills (id) on delete set null, selected_skill_id_snapshot text, selected_agent_name_snapshot text, selected_agent_responsibility_snapshot text, selected_skill_name_snapshot text, selected_skill_instructions_snapshot text, selected_skill_provider_snapshot text, selected_skill_kind_snapshot text, selected_skill_model_snapshot text, selected_skill_effort_snapshot text, skill_execution_request_snapshot text,
  unique (project_id, trigger_message_id)
);
...
CREATE TABLE briar_issue_execution_proposals (
  ...
  requested_provider text check (
    ...
    or requested_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')
  ),
...
CREATE TABLE briar_run_cost_records (
  ...
  agent_provider text not null check (
    agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy')
  ),
...
CREATE TABLE briar_run_evidence (
  ...
  check (revision >= 1), github_association_started_at text,
...
insert into "briar_execution_workers" select * from "briar_provider_backup_execution_workers";
...
insert into "briar_project_execution_worker_allowlist" select * from "briar_provider_backup_project_execution_worker_allowlist";

insert into "briar_project_execution_worker_policies" select * from "briar_provider_backup_project_execution_worker_policies";
...
drop table "briar_provider_backup_project_execution_worker_policies";

drop table "briar_provider_backup_project_execution_worker_allowlist";
...
drop table "briar_provider_backup_execution_workers";
