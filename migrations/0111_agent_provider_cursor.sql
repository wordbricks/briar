-- Add cursor to every persisted Agent provider constraint.
...
CREATE TABLE "briar_hunt_runs" (
  ...
  requested_agent_provider text check (
    ...
    or requested_agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy', 'cursor')
  ),
  preferred_agent_provider text check (
    preferred_agent_provider is null
    or preferred_agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy', 'cursor')
  ),
...
CREATE TABLE "briar_channel_messages" (
  ...
  author_agent_provider text check (
    ...
    or author_agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy', 'cursor')
  ),
...
CREATE TABLE briar_issue_execution_proposals (
  ...
  requested_provider text check (
    ...
    or requested_provider in ('codex', 'claude', 'grok', 'opencode', 'agy', 'cursor')
  ),
...
CREATE TABLE briar_run_cost_records (
  ...
  agent_provider text not null check (
    agent_provider in ('codex', 'claude', 'grok', 'opencode', 'agy', 'cursor')
  ),
