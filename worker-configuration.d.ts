/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5a21d1c2a3a6658b8433a97773396a8a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
declare module "*.svg" {
	const value: string;
