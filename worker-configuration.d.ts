/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f662b39bed255d35de0c3bb3e95d349e)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ChannelRealtimeHub" | "ChannelActivityHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_SIGNING_SECRET" | "SLACK_TOKEN_ENCRYPTION_KEY">> {}
}
declare module "*.svg" {
	const value: string;
